@php
    ...
    $description= 'This page delete the category '.$category[0]->id;
    $url = 'category';
    $delete_component = 'delete_category';
@endphp
        <!DOCTYPE html>
                    ...
                    <form method="POST" action="{{ config('app.url')}}/admin/{{$url}}/{{$delete_component}}">
                        ...
                        <div class="form-input">
                            <div class="field">
                                ...
                                <div class="control">
                                    <input class="input" type="text" name="id" value="{{ $category[0]->id }}" readonly>
                                </div>
                            </div>
                            <div class="field">
                                <label class="label">Name</label>
                                <div class="control">
                                    <input class="input" type="text" name="name" value="{{ $category[0]->name }}"
                                           readonly>
                                </div>
                            </div>
