@php
    ...
    $title = 'View Category';
    $description= 'This page view the category '.$category[0]->name;
    $url = 'category';
    $view_component = 'view_category';
@endphp
        <!DOCTYPE html>
                    ...
                    <fieldset disabled>
                        <div class="form-input">
                            <div class="field">
                                ...
                                <div class="control">
                                    <input class="input" type="text" name="id" value="{{ $category[0]->id }}">
                                </div>
                            </div>
                            <div class="field">
                                <label class="label">Name</label>
                                <div class="control">
                                    <input class="input" type="text" name="id" value="{{ $category[0]->name }}">
                                </div>
                            </div>
                        </div>
                    </fieldset>
