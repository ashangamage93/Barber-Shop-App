@php
    ...
    $description= 'This page delete the customer '.$customer[0]->id;
    $url = 'customer';
    $delete_component = 'delete_customer';
@endphp
        <!DOCTYPE html>
                    ...
                    <form method="POST" action="{{ config('app.url')}}/admin/{{$url}}/{{$delete_component}}">
                        ...
                        <div class="form-input">
                            <div class="field">
                                ...
                                <div class="control">
                                    <input class="input" type="text" name="id" value="{{ $customer[0]->id }}" readonly>
                                </div>
                            </div>
                            <div class="field">
                                <label class="label">Name</label>
                                <div class="control">
                                    <input class="input" type="text" name="name" value="{{ $customer[0]->username }}"
                                           readonly>
                                </div>
                            </div>
