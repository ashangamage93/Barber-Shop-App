@php
    ...
    $title = 'View Event';
    $description= 'This page view the event '.$event[0]->title;
    $url = 'event';
    $view_component = 'view_event';
@endphp
        <!DOCTYPE html>
                    ...
                    <fieldset disabled>
                        <div class="form-input">
                            <div class="field">
                                ...
                                <div class="control">
                                    <input class="input" type="text" name="id" value="{{ $event[0]->id }}">
                                </div>
                            </div>
                            <div class="field">
                                <label class="label">Title</label>
                                <div class="control">
                                    <input class="input" type="text" name="title" value="{{ $event[0]->title }}">
                                </div>
                            </div>
                            <div class="field">
