@php
    ...
    $description= 'This page delete the service '.$service[0]->id;
    $url = 'service';
    $delete_component = 'delete_service';
@endphp
        <!DOCTYPE html>
                    ...
                    <form method="POST" action="{{ config('app.url')}}/admin/{{$url}}/{{$delete_component}}">
                        ...
                        <div class="form-input">
                            ...
                            <div class="field">
                                ...
                                <div class="control">
                                    <input class="input" type="text" name="service" value="{{ $service[0]->name }}"
                                           readonly>
                                </div>
                            </div>
                            <div class="field">
                                ...
                                <div class="control">
                                    <input class="input" type="text" name="customer" value="{{ $service[0]->username }}"
                                           readonly>
                                </div>
                            </div>
