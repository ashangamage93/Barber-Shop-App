@php
    ...
    $description= 'This page view the sub category '.$sub_category[0]->name;
    $url = 'sub_category';
    $view_component = 'view_sub_category';
@endphp
        <!DOCTYPE html>
                    ...
                    <fieldset disabled>
                        <div class="form-input">
                            <div class="field">
                                ...
                                <div class="control">
                                    <input class="input" type="text" name="id" value="{{ $sub_category[0]->id }}">
                                </div>
                            </div>
                            <div class="field">
                                <label class="label">Name</label>
                                <div class="control">
                                    <input class="input" type="text" name="id" value="{{ $sub_category[0]->name }}">
                                </div>
                            </div>
                            <div class="field">
                                <label class="label">Category</label>
                                <div class="control">
                                    <input class="input" type="text" name="id" value="{{ $sub_category[0]->category }}">
                                </div>
                            </div>
                        </div>
                    </fieldset>
