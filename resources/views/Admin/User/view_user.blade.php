@php
    ...
    $title = 'View User';
    $description= 'This page view the user '.$admin[0]->username;
    $url = 'user';
    $view_component = 'view_user';
@endphp
        <!DOCTYPE html>
                    ...
                    <fieldset disabled>
                        <div class="form-input">
                            <div class="field">
                                ...
                                <div class="control">
                                    <input class="input" type="text" name="id" value="{{ $admin[0]->id }}">
                                </div>
                            </div>
                            <div class="field">
                            ...
                            <div class="field">
                                ...
                                <div class="control">
                                    <input class="input" type="email" name="email" value="{{ $admin[0]->email }}">
                                </div>
                            </div>
                            <div class="field">
                                <label class="label">Created</label>
                                <div class="control">
                                    <input class="input" type="text" name="created" value="{{ $admin[0]->created }}">
                                </div>
                            </div>
                        </div>
                    </fieldset>
