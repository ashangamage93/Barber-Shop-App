...
<head>
    ...
    <!-- site metas -->
    <title>Empire Cuts | Testimonial</title>
    <!-- fevicon -->
                            ...
                            <div class="limit-box">
                                <nav class="main-menu ">
                                    <ul class="menu-area-main">
                                        ...
                                        <li class="active"><a href="/testimonial">Testimonial</a></li>
                            ...
                            <div class="row">
                                <div class="col-xl-3 col-lg-3 col-md-3 col-sm-12 pa_right">
                                    <div class="testomonial_img">
                                        <figure><img src="web/image/tes.jpg" alt="#"/></figure>
                                        <i><img src="web/image/test_con.png" alt="#"/></i>
                                    </div>
                                </div>
...
<div class="footer">
    ...
    <div class="copyright">
        <div class="container">
            <p>Copyright © 2021 Design by <a href="/">Empire Cuts </a></p>
        </div>
    </div>
</div>
